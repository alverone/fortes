  ...
  if (document.querySelector('.slider-wrapper.splide') != undefined) {
    ...
    splide.on('move', (index, ..._) => {
      ...
      switch (index) {
        case 0:
          textPrev = '';
          textNext = containsRuPath
            ? StringConsts.ruSeeBedroom
            : StringConsts.seeBedroom;
          $splidePrev.classList.add('disabled');
          break;
        case 1:
          textPrev = containsRuPath
            ? StringConsts.ruSeeLivingroom
            : StringConsts.seeLivingroom;
          textNext = containsRuPath
            ? StringConsts.ruSeeKitchen
            : StringConsts.seeKitchen;
          break;
        case 2:
          textPrev = containsRuPath
            ? StringConsts.ruSeeBedroom
            : StringConsts.seeBedroom;
          textNext = containsRuPath
            ? StringConsts.ruSeeShower
            : StringConsts.seeShower;
          break;
        case 3:
          textPrev = containsRuPath
            ? StringConsts.ruSeeKitchen
